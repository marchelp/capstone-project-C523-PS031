...
const CampSite = ({ backgroundImage, title, subtitle, centerText }: CampProps) => {
  return (
    <div className={`h-full w-full min-w-[1440px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl relative`}>
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        <div className="flexCenter gap-4">
        <div className="p-4">
  <img
    src="/logosetorsampah-02.png"
    alt="map"
  ...
  />
        ...
        {/* Tambahkan teks di tengah gambar */}
        <div className="absolute inset-0 flex items-center justify-center text-white">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white text-left lg:-mt-20 lg:-ml-80">
...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20 ">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-5 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite 
          backgroundImage="bg-bg-img-1"
          title="Setor Sampah"
          centerText="Langkah Digital, Jejak Hijau, Untuk Taman Nasional Tanpa Jejak Plastik."
        />
        <CampSite 
          backgroundImage="bg-bg-img-2"
          title="Mountain View Camp"
          centerText="Teks di Tengah Gambar 2"
        />
      </div>
